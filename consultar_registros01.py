...
# Obtener todos los registros de la entidad locales.
# Se hace uso del método query.
# all, significa que se obtiene todos los registros
lista_locales = session.query(locales).all()
# La variable lista_autores, tendrá un listado de objetos de tipo locales.

# se realiza un proceso iterativo para presentar la información
# de cada objeto.
for l in lista_locales:
    print(l)
